  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      while(running){
        ...
        //Checksum input calculation.
        byte[] received = inputText.getBytes();
        ByteArrayInputStream biasIn = new ByteArrayInputStream(received);
        CheckedInputStream cis1 = new CheckedInputStream(biasIn, new Adler32());
        byte readBuffer1[] = new byte[10];
        while(cis1.read(readBuffer1) >= 0) {
          receiveChecksum = cis1.getChecksum().getValue();
